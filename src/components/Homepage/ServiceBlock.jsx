      ...
      <div className="container-xxl py-5">
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-lg-3 col-sm-6 wow animated fadeInUp" data-wow-delay="0.1s">
            ...
            <div className="col-lg-3 col-sm-6 wow animated fadeInUp" data-wow-delay="0.3s">
              <div className="service-item rounded pt-3">
                <div className="p-4">
            ...
            <div className="col-lg-3 col-sm-6 wow animated fadeInUp" data-wow-delay="0.5s">
              <div className="service-item rounded pt-3">
                <div className="p-4">
            ...
            <div className="col-lg-3 col-sm-6 wow animated fadeInUp" data-wow-delay="0.7s">
              <div className="service-item rounded pt-3">
                <div className="p-4">
